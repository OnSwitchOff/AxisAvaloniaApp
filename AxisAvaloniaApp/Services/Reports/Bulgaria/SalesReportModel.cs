...
namespace AxisAvaloniaApp.Services.Reports.Bulgaria
{
    public class SalesReportModel : IReportModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesReportModel"/> class.
        /// </summary>
        ...
        public SalesReportModel(int rowNumber = 0)
        {
        ...
        /// <summary>
        /// Gets or sets number of the current operation.
        /// </summary>
        /// <date>07.06.2022.</date>
        public string Acct { get; set; }

        /// <summary>
        /// Gets or sets date of the current operation.
        /// </summary>
        /// <date>07.06.2022.</date>

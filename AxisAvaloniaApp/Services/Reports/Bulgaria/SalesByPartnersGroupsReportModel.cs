...
{
    internal class SalesByPartnersGroupsReportModel : IReportModel
    {
        private ISettingsService settingsService;

        /// <summary>
        /// Initializes a new instance of the <see cref="SalesByPartnersGroupsReportModel"/> class.
        /// </summary>
        ...
        public SalesByPartnersGroupsReportModel(int rowNumber = 0)
        {
        ...
        /// <summary>
        /// Gets or sets name of an partners group.
        /// </summary>
        /// <date>07.06.2022.</date>
        public string PartnersGroupName { get; set; }

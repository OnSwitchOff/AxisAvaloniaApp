...
namespace AxisAvaloniaApp.Services.Reports.Bulgaria
{
    public class BulgarianReportsService : IReportsService
    {
        ...
        /// <date>16.06.2022.</date>
        public async Task<IEnumerable> GenerateReportData(int reportKey, ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            switch ((EBulgarianReports)reportKey)
            {
                case EBulgarianReports.Sales:
                    ...
                    source = await GetSalesReportModelList(acctFrom, acctTo, dateFrom, dateTo);
                    break;
                case EBulgarianReports.SalesByItems:
                    ...
                    source = await GetSalesByItemsReportModelList(acctFrom, acctTo, dateFrom, dateTo);                   
                    break;
                case EBulgarianReports.SalesByPartners:
                    ...
                    source = await GetSalesByPartnersReportModelList(acctFrom, acctTo, dateFrom, dateTo);                   
                    break;
                case EBulgarianReports.SalesByItemsGroups:
                    ...
                    source = await GetSalesByItemsGroupsReportModelList(acctFrom, acctTo, dateFrom, dateTo);
                    break;
                case EBulgarianReports.SalesByPartnersGroups:
                    ...
                    source = await GetSalesByPartnersGroupsReportModelList(acctFrom, acctTo, dateFrom, dateTo); 
                    break;
                ...
                case EBulgarianReports.OutputInvoices:
                    ...
                    source = await GetOutputInvoiceReportModelList(acctFrom, acctTo, dateFrom, dateTo);
                    break;
                ...
                case EBulgarianReports.OutputProformInvoices:
                    ...
                    source = await GetProformaInvoiceReportModelList(acctFrom, acctTo, dateFrom, dateTo);                    
                    break;
                case EBulgarianReports.OutputDebitNotes:
                    ...
                    source = await GetOutputDebitNoteReportModelList(acctFrom, acctTo, dateFrom, dateTo);
                    break;
                case EBulgarianReports.OutputCreditNotes:
                    ...
                    source = await GetOutputCreditNoteReportModelList(acctFrom, acctTo, dateFrom, dateTo);
                    break;
                ...
                case EBulgarianReports.NomenclatureOfItems:
                    ...
                    source = await GetNomenclatureOfItemsReportModelList(acctFrom, acctTo, dateFrom, dateTo);                   
                    break;
                case EBulgarianReports.NomenclatureOfPartners:
                    ...
                    source = await GetNomenclatureOfPartnersReportModelList(acctFrom, acctTo, dateFrom, dateTo);                   
                    break;
                case EBulgarianReports.NomenclatureOfPaymentTypes:
                    ...
                    source = await GetNomenclatureOfPaymentTypesReportModelList(acctFrom, acctTo, dateFrom, dateTo); 
                    break;
        ...
        private async Task<IEnumerable> GetNomenclatureOfPaymentTypesReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<NomenclatureOfPaymentTypesReportModel>();
            int i11 = 0;
        ...
        private async Task<IEnumerable> GetNomenclatureOfPartnersReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<NomenclatureOfPartnersReportModel>();
        ...
        private async Task<IEnumerable> GetNomenclatureOfItemsReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<NomenclatureOfItemsReportModel>();
            int i9 = 0;
        ...
        private async Task<IEnumerable> GetOutputCreditNoteReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<OutputCreditNoteReportModel>();
            int i8 = 0;
            decimal totalSum8 = 0;
        ...
        private async Task<IEnumerable> GetOutputDebitNoteReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<OutputDebitNoteReportModel>();
            int i7 = 0;
            decimal totalSum7 = 0;
        ...
        private async Task<IEnumerable> GetProformaInvoiceReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<ProformaInvoiceReportModel>();
            int i6 = 0;
            decimal totalSum6 = 0;
        ...
        private async Task<IEnumerable> GetOutputInvoiceReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<OutputInvoiceReportModel>();
            int i5 = 0;
            decimal totalSum5 = 0;
        ...
        private async Task<IEnumerable> GetSalesByPartnersGroupsReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<SalesByPartnersGroupsReportModel>();
            int i4 = 0;
        ...
        private async Task<IEnumerable> GetSalesReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var result = new ObservableCollection<SalesReportModel>();
            int i = 0;
            decimal totalQtty = 0;
            ...
            (await operationHeaderRepository.GetOperationHeadersByDatesAsync(dateFrom, dateTo, EOperTypes.Sale)).ForEach((oh) =>
            {
                oh.OperationDetails.ForEach((od) =>
                {
                    ...
                    result.Add(new SalesReportModel(i)
                    {
        ...
        private async Task<IEnumerable> GetSalesByItemsReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            ObservableCollection<SalesByItemsReportModel> source = new ObservableCollection<SalesByItemsReportModel>();
            int i1 = 0;
            ...
            source.Add(resultRow1);

            return source;
        }

        private async Task<IEnumerable> GetSalesByPartnersReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<SalesByPartnersReportModel>();
            int i2 = 0;
            decimal totalSum2 = 0;
        ...
        private async Task<IEnumerable> GetSalesByItemsGroupsReportModelList(ulong acctFrom, ulong acctTo, DateTime dateFrom, DateTime dateTo)
        {
            var source = new ObservableCollection<SalesByItemsGroupsReportModel>();
            int i3 = 0;

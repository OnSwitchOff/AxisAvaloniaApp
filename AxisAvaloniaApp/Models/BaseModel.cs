...
{
    public class BaseModel : ReactiveObject, INotifyDataErrorInfo
    {
        ...
        /// <date>13.06.2022.</date>
        public void RegisterValidationData<T, P>(string propName, Func<bool> invalidData, string errorDescriptionKey) where T : BaseModel
        {
            ...
            (this as T).WhenAnyValue(expr).Subscribe(_ =>
            {
